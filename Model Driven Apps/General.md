...
| View Name           | Columns                                      | Default Sort   |
| ------------------- | -------------------------------------------- | -------------- |
| My Active Leads     | Full Name, Company, Rating, Created On       | Created On Desc |
| Cases Due Today     | Title, Customer, Priority, SLA Due Date      | SLA Due Date Asc|
| Open Opportunities  | Name, Account, Est. Revenue, Close Date      | Close Date Asc |

### Bad

| View Name    | Columns                                                                                           | Default Sort |
| ------------ | ------------------------------------------------------------------------------------------------- | ------------ |
| All Records  | All 20+ columns from the table including internal IDs, created by, modified by, state, status, etc. | None         |
...
- _"Customer Service Hub for the Tier 1 and Tier 2 support teams. Includes Cases, Knowledge Articles, Queues, and the Case Resolution dashboard. Assigned to the Customer Service Representative and Customer Service Manager security roles."_
- _"Sales Operations app for the inside sales team. Covers Leads, Opportunities, Quotes, and the Sales Pipeline dashboard. Restricted to the Sales Representative and Sales Manager roles."_

### Bad

- _"App 1"_ — provides no context about the app's purpose or audience.
