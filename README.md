...
| Rule ID | Description |
|---------|-------------|
| [PA-001](/Power%20Automate/Cloud-Flows.md#pa-001-naming) | Cloud flow names must follow a defined naming pattern |
| [PA-002](/Power%20Automate/Cloud-Flows.md#pa-002-description) | All flows must have a description summarizing their purpose and business process |
| [PA-003](/Power%20Automate/Cloud-Flows.md#pa-003-trigger-names) | Trigger names should be clear and descriptive |
| [PA-004](/Power%20Automate/Cloud-Flows.md#pa-004-action-names) | All actions must be renamed to clear, descriptive names |
| [PA-005](/Power%20Automate/Cloud-Flows.md#pa-005-variable-names) | Variable names must use camelCase with a short type prefix |
| [PA-006](/Power%20Automate/Cloud-Flows.md#pa-006-connection-reference-names) | Connection reference names must follow a defined naming pattern |
| [PA-007](/Power%20Automate/Cloud-Flows.md#pa-007-error-handling) | Implement error handling using the Scope-based Try-Catch-Finally pattern |
| [PA-008](/Power%20Automate/Cloud-Flows.md#pa-008-initialize-variables-at-the-top) | Initialize all variables at the very beginning of the flow |
| [PA-009](/Power%20Automate/Cloud-Flows.md#pa-009-avoid-hardcoded-values) | Avoid hardcoded values — use Environment Variables instead |
| [PA-010](/Power%20Automate/Cloud-Flows.md#pa-010-use-child-flows-for-reusability) | Extract reusable logic into Child Flows |
| [PA-011](/Power%20Automate/Cloud-Flows.md#pa-011-add-notes-to-complex-actions) | Add notes to complex actions to document expressions and business logic |
| [PA-012](/Power%20Automate/Cloud-Flows.md#pa-012-solution-aware-flows) | All cloud flows must be created inside a Solution |
| [PA-013](/Power%20Automate/Cloud-Flows.md#pa-013-dataverse-trigger-configuration) | Configure Dataverse triggers with specific triggering fields and conditions |
| [PA-014](/Power%20Automate/Cloud-Flows.md#pa-014-dataverse-query-optimization) | Minimize the number of columns and rows retrieved when querying Dataverse |
